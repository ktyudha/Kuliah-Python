...
class Pinger(object):
    ...
    def do_checksum(self, source_string):
        ...
        while count < max_count:
            ...
            # ### uncomment the above line, and commenout the below line.
    ...
    def send_ping(self, sock, ID):
        ...
        # Calculate the checksum over the entire packet
        my_checksum = self.do_checksum(header + data)

        if my_checksum is not None:
            # Ensure my_checksum is within 16-bit range
            my_checksum &= 0xFFFF
            ...
            print("Error: Unable to calculate checksum.")
    ...
    def ping_once(self):
        ...
        try:
            ...
            # Not superuser, so operation not permitted
                e.strerror += "ICMP messages can only be sent from root user processes"
